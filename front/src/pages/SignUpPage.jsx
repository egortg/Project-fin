...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-emerald-400'>Создайте свою учетную запись</h2>
			</motion.div>
			...
			>
				<div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
					...
					У вас уже есть учетная запись?{" "}
						...
						Войдите  здесь <ArrowRight className='inline h-4 w-4' />
						</Link>
					</p>
				</div>
			</motion.div>
